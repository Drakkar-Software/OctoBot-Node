...
@pytest.fixture
def schedule_task():
    return octobot_node.app.models.Task(
        name="test_task",
        ...
        type=octobot_node.app.models.TaskType.EXECUTE_ACTIONS.value,
    )
...
class TestHueyTasks:
    ...
    def _assert_task_result(self, result: dict, expected_result: dict):
        assert result[octobot_node.app.enums.TaskResultKeys.STATUS.value] == octobot_node.app.models.TaskStatus.COMPLETED.value
        task_result = result[octobot_node.app.enums.TaskResultKeys.RESULT.value]
        ...
        if encrypted_result:
            ...
            assert result[octobot_node.app.enums.TaskResultKeys.METADATA.value] is None
        assert result[octobot_node.app.enums.TaskResultKeys.TASK.value] == {"name": "test_task"}
        assert result[octobot_node.app.enums.TaskResultKeys.ERROR.value] is None
